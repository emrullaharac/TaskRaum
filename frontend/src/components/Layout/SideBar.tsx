import {Drawer, List, ListItemButton, ListItemIcon, ListItemText, Toolbar,
    Divider, Box, Tooltip} from "@mui/material";
                    ...
                    return (
                        <Tooltip key={item.to} title={!open ? item.label : ""} placement="right">
                            <ListItemButton
                                ...
                                to={item.to}
                                selected={selected}
                                sx={{ px: open ? 2 : 1.25, justifyContent: open ? "flex-start" : "center" }}
                            >
